...
void 	zadanye1(int &w,int &n) {
	...
	if (w / 10 != 0) {
		...
		printf("Сумма цифр равна: %d", n+w);
	}


}

void 	zadanye2(int a,int &b,int &c) {
	if (b != 1)
	{
		c = a * c;
		b = b - 1;
...
void 	zadanye5() {
	...
	int sum = 0;
	func5(&n, &sum);
	printf("Сумма чисел равна: %d",sum+1);
}
